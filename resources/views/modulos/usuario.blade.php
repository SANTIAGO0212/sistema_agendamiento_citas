        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                    data-bs-target="#exampleModalRestaurar">
                    Restaurar
                </button>
                ...
                <div class="modal-body">
                    <form method="post" id="form_create">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                <label for="tipo_identificacion_label mb-2">Tipo De Identificación <span
                                ...
                                <select id="tipo_identificacion" name="tipo_identificacion" class="form-control" required>
                                    ...
                                    @foreach ($tipo_documentos as $tipo_documento)
                                        <option value="{{ $tipo_documento->id }}">
                                            ...
                                            {{ $tipo_documento->nom_tipo_documento }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                <label for="numero_identificacion_label mb-2">Número De Identificación <span
                                        style="color:red;">*</span></label>
                                <input type="text" id="num_identificacion" name="num_identificacion" class="form-control"
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                <label for="primer_nombre_label mb-2">Primer Nombre <span style="color:red;">*</span>
                                </label>
                                <input type="text" id="primer_nombre" name="primer_nombre" class="form-control"
                                    placeholder="Primer nombre del usuario" required>
                            </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6 mb-2">
                                <label for="primer_apellido_label">Primer Apellido <span style="color:red;">*</span>
                                </label>
                    ...
                    <form id="form_create">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="tipo_identificacion_ver" name="tipo_identificacion_ver"
                                    class="form-control" disabled>
                            </div>

                            <div class="col-md-6">
                                <label for="numero_identificacion_label mb-2">Número De Identificación</label>
                                <input type="text" id="numero_identificacion_ver" name="numero_identificacion_ver"
                                    class="form-control" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="primer_nombre_ver" name="primer_nombre_ver" class="form-control"
                                    disabled>
                            </div>

                            <div class="col-md-6">
                                <label for="segundo_nombre_label mb-2">Segundo Nombre</label>
                                <input type="text" id="segundo_nombre_ver" name="segundo_nombre_ver" class="form-control"
                                    disabled>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" id="primer_apellido_ver" name="primer_apellido_ver" class="form-control"
                                    disabled>
                            </div>

                            <div class="col-md-6">
                                <label for="segundo_apellido_label mb-2">Segundo Apellido</label>
                                <input type="text" id="segundo_apellido_ver" name="segundo_apellido_ver"
                                    class="form-control" disabled>
                            </div>
                        </div>
                    ...
                    <form method="post" id="form_create">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="tipo_identificacion_label mb-2">Tipo De Identificación <span
                                        style="color:red;">*</span></label>
                                <select id="tipo_identificacion_actualizar" name="tipo_identificacion_actualizar"
                            ...
                            <div class="col-md-6">
                                <label for="numero_identificacion_label mb-2">Número De Identificación</label>
                                <input type="text" id="numero_identificacion_actualizar"
                                    name="numero_identificacion_actualizar" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="primer_nombre_actualizar" name="primer_nombre_actualizar"
                                    class="form-control" required>
                            </div>

                            <div class="col-md-6">
                                <label for="segundo_nombre_label mb-2">Segundo Nombre</label>
                                <input type="text" id="segundo_nombre_actualizar" name="segundo_nombre_actualizar"
                                    class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" id="primer_apellido_actualizar" name="primer_apellido_actualizar"
                                    class="form-control" required>
                            </div>

                            <div class="col-md-6">
                                <label for="segundo_apellido_label mb-2">Segundo Apellido</label>
                                <input type="text" id="segundo_apellido_actualizar" name="segundo_apellido_actualizar"
                                    class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="email_label mb-2">Correo electrónico <span style="color:red;">*</span> </label>
                                <input type="email" id="email_actualizar" name="email_actualizar" class="form-control"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                <label for="direccion_label mb-2">Dirección <span style="color:red;">*</span> </label>
                                <input type="text" id="direccion_actualizar" name="direccion_actualizar"
                                    class="form-control" required>
                            </div>
                            <div class="col-md-6">
                                <label for="telefono_label mb-2">Teléfono <span style="color:red;">*</span> </label>
    ...
    <div class="modal fade" id="exampleModalRestaurar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- BUSCADOR -->
                    <div class="position-relative ms-auto" style="width: 180px;">
                        <i class='bx bx-search position-absolute'
                            style="top: 50%; left: 10px; transform: translateY(-50%); color: gray;"></i>

                        <input type="text" id="input_buscar_inactivo" class="form-control ps-5" placeholder="Buscar...">
                    </div>
                        ...
                        <tbody id="tabla_usuarios_inactivos">
                            @foreach($usuarios_inactivos as $usuario_inactivo)
                                <tr id="fila_usuario_inactivo_{{ $usuario_inactivo['id'] }}">
                                    ...
                                    @endif
                                    <td class="text-center align-middle">
                                        <a style="color: orange; cursor: pointer;" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalVer" data-id="{{ $usuario_inactivo['id'] }}"
                                            data-nombre="{{ $usuario_inactivo['name'] }}"
                                            data-email="{{ $usuario_inactivo['email'] }}"
                                            data-estado="{{ $usuario_inactivo['estado'] }}"
                                            ...
                                            data-tipo_identificacion="{{ $usuario_inactivo->tipoDocumento->cod_tipo_documento }} - {{ $usuario_inactivo->tipoDocumento->nom_tipo_documento }}"
                                            data-genero="{{ $usuario_inactivo->genero->nom_genero }}"><i
                                                class="bx bx-show"></i></a>
                                        <a style="color: gold; cursor: pointer;align-items: center;"
                                            data-id="{{ $usuario_inactivo['id'] }}" onclick="restaurar_usuario(this)"><i
                    ...
                    <div class="position-relative mt-3">
                        ...
                        <div id="paginacion_inactivo" class="position-absolute top-50 end-0 translate-middle-y">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
